...
public class AppointmentBookinDocSelectActicity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_booking_doc_select);
    ...
    private void parseData(JSONArray response) {
        try{
            ...
            mRecycler.setAdapter(new SampleAdapter(AppointmentBookinDocSelectActicity.this,docDetails));
            hideProgressDialog();
