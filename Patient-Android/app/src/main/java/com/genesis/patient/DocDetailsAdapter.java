...
/**
 * Created by hassan on 10/11/17. DocDetailsAdapter
 */

public class DocDetailsAdapter extends RecyclerView.Adapter<DocDetailsAdapter.ViewHolder> {
    private List<String> values;
    private ArrayList<AppointmentDetails> appDetails;
...
//    }
    ...
    public DocDetailsAdapter(ArrayList<AppointmentDetails> appDetails){
        this.appDetails = appDetails;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public DocDetailsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v = inflater.inflate(R.layout.singe_doc_details, parent, false);
